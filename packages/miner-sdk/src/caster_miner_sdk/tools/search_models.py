...
class SearchRepoSearchRequest(BaseModel):
    """Query parameters for the `search_repo` tool."""
...
class GetRepoFileResponse(BaseModel):
    """Response payload for the `get_repo_file` tool."""
