...
_DEFAULT_MODEL_ALIASES: Mapping[str, str] = {
    ...
    "vertex-maas:deepseek-ai/DeepSeek-V3.2-TEE": "deepseek-ai/deepseek-v3.2-maas",
    ...
    "vertex-maas:Qwen/Qwen3-235B-A22B-Instruct-2507-TEE": "qwen3-235b-a22b-instruct-2507-maas",
